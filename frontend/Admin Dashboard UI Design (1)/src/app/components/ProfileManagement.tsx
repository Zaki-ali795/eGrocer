      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        >
          <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 text-center relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-br from-[var(--primary)] to-[var(--secondary)] opacity-10"></div>
            
            <div className="relative mt-8 mb-6">
              <div className="w-32 h-32 bg-[var(--primary)]/10 rounded-full flex items-center justify-center mx-auto border-4 border-white shadow-xl">
            ...
            <p className="font-['Manrope'] text-[var(--primary)] font-bold text-sm uppercase tracking-wider mt-1">{profileData.role}</p>
            ...
            <div className="mt-8 pt-8 border-t border-gray-100 grid grid-cols-2 gap-4">
              ...
              <div className="text-center">
                ...
                <div className="flex items-center justify-center gap-1.5">
                  ...
                  <p className="text-sm font-bold text-[var(--green-dark)]">Active</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border-2 border-transparent rounded-2xl focus:bg-white focus:border-[var(--primary)]/20 focus:outline-none transition-all" 
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="md:col-span-2 space-y-2">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-gray-50 border-2 border-transparent rounded-2xl focus:bg-white focus:border-[var(--primary)]/20 focus:outline-none transition-all" 
                  />
                </div>
              </div>
              <div className="md:col-span-2 space-y-2">
                ...
                <textarea 
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border-2 border-transparent rounded-2xl focus:bg-white focus:border-[var(--primary)]/20 focus:outline-none transition-all resize-none" 
                />
              </div>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-100 flex justify-end">
              <motion.button
                ...
                onClick={handleSave}
                disabled={loading}
                className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-[var(--green-dark)] to-[var(--green-primary)] text-white rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all disabled:opacity-50"
              >
